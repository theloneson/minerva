...
export default function AboutUs() {
  ...
  // Auto-advance the testimonial carousel continuously.
          ...
          <section className="absolute left-[15px] top-[2622px] w-[1898px] h-[596px]">
            <span className="absolute left-[430px] top-[195px] font-oswald font-semibold text-[100px] leading-[67px] tracking-[5px] whitespace-nowrap text-transparent" style={{ WebkitTextStroke: '2px #F3274C' }}>Our</span>
        ...
        <section className="relative overflow-hidden bg-black">
          ...
          <div className="relative px-6 md:px-12 pt-40 pb-20 flex flex-col items-center gap-5 text-center">
            ...
            <p className="max-w-xl font-semibold italic text-[15px] md:text-[18px] leading-relaxed text-[#F4F1F1]">
              TheLiquidSpot is a food and beverage brand built on freshly prepared handmade food and specialty drinks — made with quality ingredients, crafted with intention.
            </p>
          </div>
        </section>
