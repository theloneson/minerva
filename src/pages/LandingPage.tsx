    ...
    <>
      ...
      <div className="lg:hidden w-full overflow-x-hidden bg-white font-nunito">
        ...
        <section className="px-6 md:px-12 py-14 flex flex-col items-center gap-4 text-center">
          ...
          <span className="mt-6 font-oswald font-bold text-[18px] md:text-[22px] tracking-[2px] text-brand-red">THELIQUIDSPOT</span>
...
const menuGroups = [
  ...
  },
  {
    name: "Loaded & Cheesy",
    cards: [
      { label: "Extra Loaded", title: "Loaded Shawarma", price: "£13", spice: true, bg: "url('/figma/landing/assets/ded90afec8a34908.png') 8% 50% / cover no-repeat", desc: "Extremely filling and boldly flavoured. Made with 100% seasoned chicken or beef, topped with frankfurters and our in-house dressing. Perfect for when you want a break from veggies.", ingr: "Ingredients: Carrots, cabbage, chicken and/or beef, frankfurter, in-house dressing", allergen: "Allergen advice: May contain traces of eggs, cheese, mustard." },
