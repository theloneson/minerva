...
export function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 hover:shadow-[0_6px_25px_rgba(37,211,102,0.6)] transition-all duration-300"
    >
      <i className="fab fa-whatsapp text-3xl md:text-4xl" />
    </a>
  );
}